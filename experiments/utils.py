...
common_parser.add_argument("--gpu", type=int, default=3, help="gpu device ID")
...
common_parser.add_argument("--stch", type=str, required=True, help="stch method mode")
common_parser.add_argument("--loc", type=str, required=True, help="loc method mode")
